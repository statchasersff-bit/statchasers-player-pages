<!-- SCPP TEMPLATE MARKER: 2026-02-19-BBB -->
<?php
...
<style>
    ...
    .scpp-root .sc-players .sc-breadcrumb a { text-decoration: none; color: #2563eb; font-size: 14px; }
    .scpp-root .sc-players .sc-player-header { margin-bottom: 32px; }
    .scpp-root .sc-players .sc-page-title { font-size: 2em; margin: 0 0 8px 0; padding: 0; line-height: 1.2; }
    .scpp-root .sc-players .sc-player-meta-line { font-size: 1.1em; color: #6b7280; margin: 0; }
    .scpp-root .sc-players .sc-badge { display: inline-block; margin-top: 8px; font-size: 12px; font-weight: 600; padding: 3px 10px; border-radius: 4px; }
    .scpp-root .sc-players .sc-badge-status { background: rgba(59,130,246,0.1); color: #2563eb; }
    .scpp-root .sc-players .sc-badge-injury { background: #fef2f2; color: #dc2626; margin-left: 6px; }
    .scpp-root .sc-players .sc-injury-alert { background: #fef2f2; border: 1px solid #fca5a5; border-radius: 6px; padding: 14px 18px; margin-bottom: 24px; }
    .scpp-root .sc-players .sc-injury-alert strong { color: #dc2626; }
    .scpp-root .sc-players .sc-injury-alert p { margin: 6px 0 0; color: #6b7280; font-size: 0.9em; }
    .scpp-root .sc-players .sc-card { background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 24px; margin-bottom: 24px; }
    .scpp-root .sc-players .sc-card-title { font-size: 1.3em; margin: 0 0 16px 0; padding: 0; }
    .scpp-root .sc-players .sc-card-placeholder { color: #9ca3af; font-size: 0.9em; margin: 0; }
    .scpp-root .sc-players .sc-snapshot-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(160px, 1fr)); gap: 14px; }
    .scpp-root .sc-players .sc-snapshot-item { background: #fff; border-radius: 6px; padding: 12px 16px; }
    .scpp-root .sc-players .sc-snapshot-label { display: block; font-size: 0.75em; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em; }
    .scpp-root .sc-players .sc-snapshot-value { font-size: 1.1em; font-weight: 600; }
    .scpp-root .sc-players .sc-sections-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 16px; margin-bottom: 8px; }
    .scpp-root .sc-players .sc-sections-grid .sc-card { margin-bottom: 0; }
    .scpp-root .sc-players .sc-sections-grid .sc-card-title { font-size: 1.15em; margin-bottom: 8px; }
    .scpp-root .sc-players .sc-related-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 12px; }
    .scpp-root .sc-players .sc-related-link {
    ...
    .scpp-root .sc-players .sc-related-link:hover { border-color: #9ca3af; }
    .scpp-root .sc-players .sc-related-icon {
        width: 34px; height: 34px; border-radius: 6px; background: #e5e7eb;
        display: flex; align-items: center; justify-content: center; flex-shrink: 0;
    }
    .scpp-root .sc-players .sc-related-icon span { font-size: 10px; font-weight: 700; color: #6b7280; }
    .scpp-root .sc-players .sc-related-name { font-size: 14px; display: block; }
    .scpp-root .sc-players .sc-related-team { font-size: 12px; color: #9ca3af; }
    .scpp-root .sc-players .sc-nav-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 12px; margin-top: 24px; }
    .scpp-root .sc-players .sc-nav-link {
        display: block; background: #f9fafb; border: 1px solid #e5e7eb;
        border-radius: 8px; padding: 16px; text-decoration: none; color: inherit;
    }
    .scpp-root .sc-players .sc-nav-link:hover { border-color: #9ca3af; }
    .scpp-root .sc-players .sc-nav-link strong { display: block; color: #111827; }
