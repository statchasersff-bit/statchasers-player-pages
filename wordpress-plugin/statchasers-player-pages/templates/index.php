...
<div id="sc-player-index" style="max-width: 960px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="margin-bottom: 24px;">
        <input
            ...
            autocomplete="off"
            style="width: 100%; padding: 12px 16px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 16px; outline: none; box-sizing: border-box;"
        />
    </div>

    <p id="sc-results-count" style="font-size: 0.9em; color: #9ca3af; margin-bottom: 16px;">Type a name or team to search</p>
...
<style>
    ...
    .sc-result-row:hover,
    .sc-result-row.sc-active {
        background-color: #f9fafb;
    }
    .sc-result-row:first-child {
